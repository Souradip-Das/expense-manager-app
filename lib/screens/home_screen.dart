...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Future<void> _loadData() async {
    ...
    if (mounted) setState(() { _isLoadingData = false; _filter = const TransactionFilter(); });
  }
                ...
                children: [
                  ...
                  if (creditCards.isEmpty)
                    const Padding(
                      padding: EdgeInsets.all(16),
                      child: Center(
                        child: Text('No credit card entries.',
                            style: TextStyle(color: Colors.white38)),
                      ),
                    )
                  else
                    ...creditCards.map((cc) => CreditCardTile(
                          item: cc,
                          onDelete: () {
                            ref
                            ...
                            SnackbarService.show(
                                context, 'Credit card entry deleted.',
                                type: SnackType.info);
                          },
                        )),
                  ...
                  if (transactions.isEmpty)
                    ...
                    ...filteredTxs.map((tx) => TransactionTile(
                          item: tx,
                          onDelete: () {
                            ref
